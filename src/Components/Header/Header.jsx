        ...
        <div className="headerContainer">
            ...
            <div className="headerLargeContainer" >
                ...
                <div className="headerSmallContainer">
                    ...
                    <a href="#parcours" target="_blank" rel="noreferrer" >En savoir plus</a>
                </div>
                <div className="headerSmallContainer">
                    ...
                    <a href="https://www.youtube.com/watch?v=weP6BLvfzG8" target="_blank" rel="noreferrer">En savoir plus</a>
                </div>
            </div>
        </div>
    );
