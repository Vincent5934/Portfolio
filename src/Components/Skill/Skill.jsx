        ...
        <div className="container">
            ...
            <div className="largeContainer">
                <div className="smallContainer">
                    <img src={logoReact} alt="logo React" className="logoReact" data-aos="fade-right" data-aos-delay="200" data-aos-duration="500"/>
                    <h3>REACT</h3>
                ...
                <div className="smallContainer">
                    <img src={langage} alt="bulle de discussion" className="logo" data-aos="fade-down" data-aos-delay="400" data-aos-duration="500" />
                ...
                <div className="smallContainer">
                    <img src={agile} alt="" className="logo"  data-aos="fade-left" data-aos-delay="600" data-aos-duration="500" />
